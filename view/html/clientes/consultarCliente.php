<div class='container-fluid mt-1 mb-1 content' id='content'>
    <div class='filtroSelect d-flex justify-content-between'>
        <div class="">
            <button onclick="modalCadastrar()" type="button" class="btn btn-primary cadastrar" data-toggle="modal" data-target="#cadastrar"> Cadastrar Cliente</button>
        </div>
        <div class='filter d-flex justify-content-end'>
            <div>
                <input type='text' id='filterVendaInput' placeholder='Filtro Cliente' class="form-control">
            </div>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Detalhes do Cliente<span id="nome_dados"></span></h4>
...
<div class="modal fade" id="editar" tabindex="-1">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Editar Cliente<span id="nome_dados"></span></h4>
                <button id="btn-fechar-perfil" type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form id="formularioEditarVenda" method="POST">
                <div class="modal-body quebra">
                    <div class="row">
                        <div class="col-md-12">
                            <label for="" class="obrigatorio"> <b> Cliente: </b></label>
                            <input type="text" class="form-control form-control-editar" id="clienteEditar" name="cliente" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <span><b>Endereço: </b></span>
                            <input class="form-control form-control-editar" id="enderecoEditar" name="endereco"></input>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <span><b>Bairro: </b></span>
                            <input class="form-control form-control-editar" id="bairroEditar" name="bairro"></input>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-2">
                            <span><b>Cep: </b></span>
                            <input class="form-control form-control-editar" id="cepEditar" name="cep"></input>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <span><b>Email: </b></span>
                            <input type="email" class="form-control form-control-editar" id="emailEditar" name="email"></input>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
...
<div class="modal fade" id="cadastrar" tabindex="-1">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Cadastrar Cliente<span id="nome_dados"></span></h4>
                <button id="btn-fechar-perfil" type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form id="formularioCadastrarVenda" method="POST">
                <div class="modal-body quebra">
                    <div class="row">
                        <div class="col-md-12">
                            <label for="" class="obrigatorio">Cliente: </label>
                            <input type="text" class="form-control form-control-cadastrar" id="clienteCadastrar" name="cliente" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <span><b>Endereço: </b></span>
                            <input class="form-control form-control-cadastrar" id="enderecoCadastrar" name="endereco"></input>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <span><b>Bairro: </b></span>
                            <input class="form-control form-control-cadastrar" id="bairroCadastrar" name="bairro"></input>
                        </div>
                        <div class="col-md-4">
                            <span class="obrigatorio"><b>Cidade: </b></span>
                        ...
                        <div class="col-md-2">
                            <span><b>Cep: </b></span>
                            <input class="form-control form-control-cadastrar" id="cepCadastrar" name="cep"></input>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <span><b>Email: </b></span>
                            <input class="form-control form-control-cadastrar" id="emailCadastrar" name="email" type="email"></input>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
